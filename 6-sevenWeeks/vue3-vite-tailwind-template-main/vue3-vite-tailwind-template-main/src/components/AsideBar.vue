<template>
  <aside class="w-80 h-screen border-r bg-white">
    ...
    <div class="text-center shadow-xl py-6 cursor-pointer">
      ...
      <h5 class="mt-4 text-xl font-semibold text-gray-600 lg:block">luochen</h5>
    ...
    <ul class="mt-6">
      ...
      <li>
        <RouterLink to="/sime" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600">
          <DocumentChartBarIcon class="h-6 w-6 text-gray-400" />
